...
import balatro.actions.CeremonialDaggerAction;
...
public class CeremonialDagger extends BaseCard {
    public static final String ID = makeID(CeremonialDagger.class.getSimpleName());
