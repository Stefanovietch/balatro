...
import balatro.powers.BaseballCardPower;
import balatro.powers.TradingCardPower;
...
public class TradingCard extends BaseCard {
    public static final String ID = makeID(TradingCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new TradingCardPower(p, this.magicNumber),this.magicNumber));
    }
