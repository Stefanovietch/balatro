...
public class IceCream extends BaseCard {
    public static final String ID = makeID(IceCream.class.getSimpleName());
    ...
    private int counterSelfReduction = 1;
    ...
    public void applyPowers() {
        super.applyPowers();
        this.block -= AbstractDungeon.actionManager.cardsPlayedThisCombat.size();
        if(this.block < 0) {this.block = 0; counterSelfReduction = 0;}
