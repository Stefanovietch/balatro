...
import balatro.powers.BusinessCardPower;
...
public class BusinessCard extends BaseCard {
    public static final String ID = makeID(BusinessCard.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new BusinessCardPower(p, this.magicNumber), this.magicNumber));
    }
