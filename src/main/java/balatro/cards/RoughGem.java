...
public class RoughGem extends BaseCard {
    public static final String ID = makeID(RoughGem.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new GainGoldAction(Math.floorDiv(p.currentBlock, magicNumber)*2));
    }
