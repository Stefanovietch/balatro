...
public class Triboulet extends BaseCard {
    public static final String ID = makeID(Triboulet.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new TribouletPower(p,1),1));
    }

    @Override
    public AbstractCard makeCopy() { //Optional
        return new Triboulet();
    }
}
