...
import balatro.powers.SeeingDoublePower;
...
public class SeeingDouble extends BaseCard {
    public static final String ID = makeID(SeeingDouble.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p,p,new SeeingDoublePower(p)));
    }

    @Override
    public AbstractCard makeCopy() { //Optional
        return new SeeingDouble();
    }
}
