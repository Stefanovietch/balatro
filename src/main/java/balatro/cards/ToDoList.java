...
public class ToDoList extends BaseCard {
    public static final String ID = makeID(ToDoList.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new ToDoListPower(p, this.magicNumber),this.magicNumber));
    }
