...
public class ScaryFace extends BaseCard {
    public static final String ID = makeID(ScaryFace.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new ScaryFacePower(p,this.magicNumber),this.magicNumber));
    }
