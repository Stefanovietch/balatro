...
public class BlueJoker extends BaseCard {
    public static final String ID = makeID(BlueJoker.class.getSimpleName());
    ...
    public void applyPowers() {
        super.applyPowers();
        this.block += AbstractDungeon.player.drawPile.group.size();
        isBlockModified = baseBlock != block;
    }

    @Override
    public AbstractCard makeCopy() { //Optional
        return new BlueJoker();
    }
}