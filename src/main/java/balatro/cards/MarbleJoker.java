...
public class MarbleJoker extends BaseCard {
    public static final String ID = makeID(MarbleJoker.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractCard s = (new Safety()).makeCopy();
        if (this.upgraded)  {
            s.upgrade();
        }
