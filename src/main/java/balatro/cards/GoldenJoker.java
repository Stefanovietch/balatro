...
public class GoldenJoker extends BaseCard {
    public static final String ID = makeID(GoldenJoker.class.getSimpleName());
    ...
    private static final int UPG_GOLD = 20;
