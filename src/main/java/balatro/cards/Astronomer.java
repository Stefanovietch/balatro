...
public class Astronomer extends BaseCard {
    public static final String ID = makeID(Astronomer.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new AstronomerPower(p, magicNumber),magicNumber));
    }
