...
public class Stuntman extends BaseCard {
    public static final String ID = makeID(Stuntman.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new DrawReductionPower(p, 2)));
    }
