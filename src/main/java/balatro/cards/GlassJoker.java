...
public class GlassJoker extends BaseCard {
    public static final String ID = makeID(GlassJoker.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new GlassJokerAction(new int[]{damage}, new DamageInfo(p, damage, DamageInfo.DamageType.NORMAL),this));
    }
