...
public class baseDeck extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("baseDeck"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(JollyJoker.ID);
        retVal.add(JollyJoker.ID);
        retVal.add(JollyJoker.ID);
        retVal.add(JollyJoker.ID);
        retVal.add(SlyJoker.ID);
        retVal.add(SlyJoker.ID);
        retVal.add(SlyJoker.ID);
        retVal.add(SlyJoker.ID);
        retVal.add(MadJoker.ID);
        retVal.add(CleverJoker.ID);
    ...
    public void setDeck(String deck) {
        this.shoulderImg = ImageMaster.loadImage(characterPath("decks/" + deck + "/shoulder.png"));
